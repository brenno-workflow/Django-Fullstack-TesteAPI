...
SECRET_KEY = 'django-insecure-o(x!6qoql3j1etv%(6jhb7ljxu+^vh@7_65r3w$a*)b#8!#1l+'
...
INSTALLED_APPS = [
    ...
    # Informar todas as pastas e subpastas de projetos e aplicativos
    'backend',
    'accounts',
    'resumes',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'teste4',             # Nome do banco de dados
